...
import { AdminTournament, AdminCourse } from '../../data/mockDatabase';
import Button from '../Button';

interface ManageTournamentsProps {
  tournaments: AdminTournament[];
  courses: AdminCourse[];
  onCreateTournament: (tournamentData: Omit<AdminTournament, 'id'>) => void;
}

const ManageTournaments: React.FC<ManageTournamentsProps> = ({ tournaments, courses, onCreateTournament }) => {
